...
/**
 * ============================================================
 *  Grimaldi Agencies Argentina — 404 No Encontrado
 * ============================================================
 */
...
<head>
    ...
    <title>404 Página no encontrada | Grimaldi Agencies Argentina</title>
...
<body>
    <div class="error-container">
        ...
        <p class="error-desc">Lo sentimos, la página que está buscando no existe, fue movida a otra dirección o no está disponible temporalmente.</p>
        
        <a href="<?php echo BASE_URL; ?>" class="ga-btn ga-btn--primary">Volver al Inicio</a>
    </div>
</body>
</html>
